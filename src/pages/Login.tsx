  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative bg-white border-2 border-blue-500 rounded-lg w-full max-w-5xl flex flex-col md:flex-row overflow-hidden shadow-lg min-h-[600px] z-10">
          {/* Left image section */}
